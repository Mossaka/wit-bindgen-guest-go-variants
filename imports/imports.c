...
int32_t __wasm_export_imports_roundtrip_option(int32_t arg, float arg0) {
  imports_option_float32_t option;
  switch (arg) {
    case 0: {
  ...
  }imports_option_float32_t arg1 = option;
  uint8_t val;
  bool ret = imports_roundtrip_option(&arg1, &val);
  
  imports_option_u8_t ret2;
  ret2.is_some = ret;
  ret2.val = val;
...
int32_t __wasm_export_imports_roundtrip_result(int32_t arg, int32_t arg0) {
  imports_result_u32_float32_t result;
  switch (arg) {
    case 0: {
      result.is_err = false;
  ...
  }imports_result_u32_float32_t arg1 = result;
  imports_result_float64_u8_t ret;
  imports_roundtrip_result(&arg1, &ret);
  int32_t ptr = (int32_t) &RET_AREA;
...
int32_t __wasm_export_imports_roundtrip_enum(int32_t arg) {
  imports_e1_t ret = imports_roundtrip_enum(arg);
  return (int32_t) ret;
}
__attribute__((export_name("variant-c1: func(a: variant { a(s32), b(s64) }) -> variant { a(s32), b(s64) }")))
int32_t __wasm_export_imports_variant_c1(int32_t arg, int64_t arg0) {
  imports_c1_t variant;
  variant.tag = arg;
  ...
  imports_c1_t arg1 = variant;
  imports_c1_t ret;
  imports_variant_c1(&arg1, &ret);
  int32_t ptr = (int32_t) &RET_AREA;
